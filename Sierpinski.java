...
public class Sierpinski {
	...
	private static void sierpinski(int n, double x1, double x2, double x3,
		...
		sierpinski(n-1, x1, (x2+x1)/2, (x3+x1)/2, (y1+y2)/2, y1, (y1+y3)/2);
		sierpinski(n-1, (x2+x1)/2, x2, (x3+x2)/2, (y1+y2)/2, y2, (y2+y3)/2);
		sierpinski(n-1, (x3+x1)/2, (x2+x3)/2, x3 , (y1+y3)/2 , (y3+y2)/2, y3);
